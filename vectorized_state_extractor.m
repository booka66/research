function [data_cell, total_channels, sampRate, NRecFrames] = vectorized_state_extractor(FileName, toleranceLvl)
...
parfor k = 1:total_channels
    ...
    [SzEventsTimes, SE_List] = getSzEnvelop_wSE(signal, sampRate, toleranceLvl, t);
